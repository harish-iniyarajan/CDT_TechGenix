...
<header class="card-header">
	<h2 class="card-title mt-4">Add Product</h2>
</header>
<br><br>
<article class="card-body">
   <c:url value="/admin/addproduct" var="url"/>
   ...
   <form:hidden path="productId"></form:hidden>
      ...
      <div class="col-sm-4">
       <form:select path="sname" class="custome-select mr-sm-2">
         <c:forEach items="${supplier }" var="s">
           <form:option value="${s.supplierName }">${s.supplierName }</form:option>
         </c:forEach>
       </form:select>
      </div>
     </div>
     ...
     <input class="btn btn-primary" type="submit" value="Add Product"></input>
   </form:form>
   </article>
   </div>
